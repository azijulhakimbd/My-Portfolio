...
const Location = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-10">
      ...
      <div className="mt-8 sm:mt-16 border-2 border-blue-900 rounded-2xl hover:shadow-xl">
        {/* Skeleton Loader */}
        {loading && (
          <Skeleton
            height={450}
        ...
        {/* Google Maps Embed */}
        <iframe
          className={`border border-blue-900 rounded-2xl transition-opacity duration-500 ${
